...
c=s.JpegStreamCamera(r"192.168.173.147:8080/videofeed")
#c=s.Camera()
c1=time.clock()
gesture_time=60
...
i1=i1.crop(0,0,img_width_ori,img_height/2).flipHorizontal()
img_width=img_width_ori
count=0
while True:
    i2=c.getImage().crop(0,0,img_width_ori,img_height/2).flipHorizontal()
    i3=(i2-i1)+(i1-i2)
    i1=i2
    ...
    if not blobs_empty:
        ...
        if not detection_sleep and detection_width> img_width*0.75:
            print("Detected")
